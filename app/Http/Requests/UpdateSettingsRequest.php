...
class UpdateSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'magicbox.seo.google_site_verification' => ['nullable', 'string', 'max:255'],
            'magicbox.seo.bing_site_verification' => ['nullable', 'string', 'max:255'],
            'magicbox.seo.yandex_verification' => ['nullable', 'string', 'max:255'],
            'magicbox.seo.twitter_handle' => ['nullable', 'string', 'max:64'],
            'magicbox.seo.locale' => ['nullable', 'string', 'max:8'],
            'magicbox.seo.og_locale' => ['nullable', 'string', 'max:8'],
            'magicbox.seo.og_image' => ['nullable', 'image', 'max:5120'],
