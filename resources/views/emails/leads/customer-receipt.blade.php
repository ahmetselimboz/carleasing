...
<head>
    ...
    <title>{{ $payload['type_label'] }} - Talebiniz alındı</title>
</head>
        ...
        <tr>
            <td style="padding:24px;">
                ...
                <p style="margin:0 0 14px;line-height:1.6;">
                    ...
                    <strong>{{ mb_strtolower((string) $payload['type_label']) }}</strong> kaydınızı aldık.
                    Ekibimiz en kısa sürede inceleyip sizinle iletişime geçecektir.
                </p>
                ...
                <p style="margin:0;font-size:13px;color:#64748b;">Bu e-posta bilgilendirme amaçlıdır.</p>
            </td>
        </tr>
    </table>
</body>
