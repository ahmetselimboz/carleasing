    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;">
        <tr>
            <td style="padding:24px;">
                <h1 style="margin:0 0 12px;font-size:20px;">Yeni {{ mb_strtolower((string) $payload['type_label']) }} oluştu</h1>
                <p style="margin:0 0 14px;line-height:1.6;">
                    Sisteme yeni bir kayıt geldi. Hızlı aksiyon için detaylar aşağıdadır.
                </p>
