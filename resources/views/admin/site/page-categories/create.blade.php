...
@section('content')
    <div class="fade-in space-y-6">
        <div>
            ...
            <h2 class="text-2xl font-bold text-slate-800">Yeni sayfa kategorisi</h2>
            <p class="text-slate-500 text-sm mt-1">Yeni kategori oluşturarak sayfaları gruplayabilirsiniz.</p>
        </div>

        <div class="card bg-white rounded-2xl border border-slate-100 shadow-sm p-6 lg:p-8">
            <form method="POST" action="{{ route('page-categories.store') }}" class="space-y-5">
                @csrf
